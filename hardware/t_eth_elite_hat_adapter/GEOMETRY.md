...
| part | top (mm) | footprint |
|---|---|---|
| **RJ45 (with magnetics)** | **15.97** | x −5.18…16.42 (hangs 5.18 off the left edge), y 10.50…28.90 |
| 40-pin header pins | 10.10 | x 6.93…57.73, y 0.86…8.40 |
| two parts at the far edge | 4.00 | x 41.48…45.98 and 52.10…56.60, y 45.85…49.35 |
| ESP32-S3-WROOM-1 | 3.90 | x 40.47…65.97, y 24.07…42.08 |

**The RJ45 is 5.87 mm taller than the header pins.** Anything that plugs onto
that header and spans the left half of the board collides with it unless it is
either notched or raised above 15.97. This is the single constraint that makes
this adapter necessary rather than merely convenient.
